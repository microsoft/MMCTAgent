"""
Centralized provider configuration for VideoAgent and IngestionPipeline.

This module loads Azure credentials and service configurations from environment
variables and provides singleton instances of VideoAgentProviderConfig and
