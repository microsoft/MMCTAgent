...
This tool orchestrates a video question-answering flow that combines transcript-based search, timestamp extraction, visual frame analysis, and reasoning with optional critic feedback. It abstracts away the complexity of retrieving relevant documents from the vector database — agents only need to provide a query, while the tool handles document retrieval, reasoning, and multimodal fusion internally.
