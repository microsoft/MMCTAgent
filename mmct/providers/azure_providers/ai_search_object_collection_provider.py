...
class AISearchObjectCollectionProvider(BaseObjectCollectionVectorDBProvider):
    """Azure AI Search provider implementation for object collection."""
    ...
    def get_index_schema(self) -> SearchIndex:
        """Creates Azure AI Search specific schema based on ObjectCollectionDocument type."""
        return create_azure_index_schema(
            model_class=ObjectCollectionDocument,
            index_name=self.index_name,
    ...
    def parse_response(self, vector_db_document: Any) -> ObjectCollectionDocument:
        """Parses the retrieved Azure vector DB document into ObjectCollectionDocument object."""
        return parse_azure_response_to_model(vector_db_document, ObjectCollectionDocument)
