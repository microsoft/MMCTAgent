...
def _log(msg: str) -> None:
    ...
    print(f"{_GRAY}[{now}]{_RESET} {_CYAN}[V5:image]{_RESET} {msg}", flush=True)
...
class ImageAnalysisExecutor:
    ...
    async def _analyze_single(self, keyframe: Dict, query: str) -> str:
    ...
    async def _resolve_image(self, image_path: str) -> str:
