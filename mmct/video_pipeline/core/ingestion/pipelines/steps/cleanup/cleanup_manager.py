...
- Keyframes: {output_dir}/keyframes/{chunk_id}/*.jpg
...
class CleanupManager:
    ...
    def __init__(
        ...
        Args:
            ...
            output_dir: Pipeline output directory containing keyframes folder
        """
    ...
    async def cleanup(self, video_id: str) -> int:
        ...
        # ============================================================
        # 4. Clean up keyframes directory
        # ============================================================
        # Keyframes are stored in {output_dir}/keyframes/{chunk_id}/
        if not self.keep_keyframes and self.output_dir:
            keyframes_dir = os.path.join(self.output_dir, "keyframes")
            if await self._delete_directory(keyframes_dir):
                deleted_count += 1
