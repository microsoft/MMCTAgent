...
from mmct.video_pipeline.graph.prompts.video_agent import VIDEO_AGENT_SYSTEM_PROMPT
...
class VideoAgent:
    ...
    def _initialize_tools(self):
        ...
        from mmct.video_pipeline.graph.tools.graph_search_tool import GraphSearchTool
        from mmct.video_pipeline.graph.tools.keyframe_tool import KeyframeRetrievalTool
        from mmct.video_pipeline.graph.tools.video_discovery_tool import VideoDiscoveryTool
        from mmct.video_pipeline.graph.tools.graph_traversal_tool import GraphTraversalTool
        from mmct.video_pipeline.graph.tools.video_overview_tool import VideoOverviewTool
