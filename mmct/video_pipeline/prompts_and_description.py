...
- [**IMPORTANT**] TERMINATE keyword always with the Final answer formatted output.
- Adhere to the format mentioned for final answer output.
- Adhere to the draft answer format.
